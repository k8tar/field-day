...
impl ConfigManager {
    ...
    pub fn update_station(&mut self, call_sign: String, name: String, section: String, class: String) -> Result<()> {
    ...
    pub fn update_mesh_config(&mut self, config: MeshConfig) -> Result<()> {
        self.config.mesh = config;
        self.save()
    }
    
    pub fn update_qso_config(&mut self, config: QsoConfig) -> Result<()> {
