...
setTimeout(() => {
  ...
  async function runTests() {
    ...
    try {
      ...
      const sections = [
        'CT', 'EMA', 'ME', 'NH', 'RI', 'VT', 'WMA', // Division 1 (New England)
        'ENY', 'NLI', 'NNJ', 'NNY', 'SNJ', 'WNY', // Division 2 (Hudson)
        'DE', 'EPA', 'MDC', 'WPA', // Division 3 (Atlantic)
        'OH', 'MI', // Division 8 (Great Lakes)
        'IL', 'IN', 'WI', // Division 9 (Central)
        'CO', 'IA', 'KS', 'MN', 'MO', 'ND', 'NE', 'SD', // Division 0
        'AL', 'GA', 'KY', 'NC', 'NFL', 'SFL', 'TN', 'VA', 'WCF', // Division 4 (Southeast)
        'AR', 'LA', 'MS', 'NM', 'NTX', 'OK', 'STX', 'WTX', // Division 5 (West Gulf)
        'EB', 'LAX', 'ORG', 'PAC', 'SB', 'SCV', 'SDG', 'SF', 'SJV', 'SV', // Division 6 (Pacific)
        'AK', 'AZ', 'EWA', 'ID', 'MT', 'NV', 'OR', 'UT', 'WWA', 'WY', // Division 7 (Northwestern)
      ...
      const callsigns = [
        ...
        'W4PQR', 'K4STU', 'N4VWX', 'KC4YZA', 'WA4BCD', // Division 4 (Southeast)
        'W5EFG', 'K5HIJ', 'N5KLM', 'KC5NOP', 'WA5QRS', // Division 5 (West Gulf)
        'W6TUV', 'K6WXY', 'N6ZAB', 'KC6CDE', 'WA6FGH', // Pacific
        'W7IJK', 'K7LMN', 'N7OPQ', 'KC7RST', 'WA7UVW', // Northwestern
        'W8XYZ', 'K8ABC', 'N8DEF', 'KC8GHI', 'WA8JKL', // Division 8 (Great Lakes)
        'W9MNO', 'K9PQR', 'N9STU', 'KC9VWX', 'WA9YZA', // Central
        'W0BCD', 'K0EFG', 'N0HIJ', 'KC0KLM', 'WA0NOP', // Division 0
