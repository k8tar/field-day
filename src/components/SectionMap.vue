        ...
        >
          ...
          <div class="sections-grid">
            <span 
              ...
              :key="section"
              :class="['section-tag', { 'logged': isLogged(section, qsos) }]"
              :title="`${section} - ${isLogged(section, qsos) ? 'Logged' : 'Not logged'}`"
            >
              {{ section }}
            </span>
          </div>
          <div class="division-stats">
            <span class="stats-text">
              {{ getLoggedCount(division.sections, qsos) }} / {{ division.sections.length }} sections
            </span>
